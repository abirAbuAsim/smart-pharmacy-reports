...
class PurchaseOrderController extends Controller
{
    ...
    public function index()
    {
        ...
        $response = $client->post('http://f883ab6c.ngrok.io/smartChemistApi/public/all-purchase-orders', [
            'headers' => [
        ...
        // Get pharmacy names
        $client = new Client;
        $response = $client->get('http://f883ab6c.ngrok.io/smartChemistApi/public/all-pharmacies-with-purchase', [
            'headers' => [
                'APPAUTHID' => 'intel_pharma',
                'APPTOKEN' => '3fb8744b8ef6f65ed9d5687c4f45e6dd',
            ],
        ...
        $response = json_decode($response->getBody(), true);
        $pharmacyList = $response['data']['pharmacy_names'];
        ...
        return view('purchase', ['orders' => $orderList, 'pharmacyList' => $pharmacyList,
    ...
    public function showSearchResult(Request $request)
    {
        ...
        $response = $client->post('http://f883ab6c.ngrok.io/smartChemistApi/public/search-purchase-orders-by-params', [
            'form_params' => [
        ...
        return view('purchase-search', ['orders' => $searchResultOrderList, 'pharmacyList' => $pharmacyList,
